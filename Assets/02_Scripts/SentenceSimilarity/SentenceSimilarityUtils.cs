...
namespace SentenceSimilarityUtils
{
    public static class SentenceSimilarityUtils_
    {
        ...
        {
            string tokenizerJsonContent = File.ReadAllText(Application.streamingAssetsPath + "/tokenizer.json");
            string tokenizerConfigJsonContent = File.ReadAllText(Application.streamingAssetsPath + "/tokenizer_config.json");

            JObject tokenizerJsonData = JsonConvert.DeserializeObject<JObject>(tokenizerJsonContent);
            JObject tokenizerConfigJsonData = JsonConvert.DeserializeObject<JObject>(tokenizerConfigJsonContent);
